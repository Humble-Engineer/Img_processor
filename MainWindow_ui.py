...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.blur_Box.setGeometry(QRect(310, 385, 100, 55))
        self.blur_button = QPushButton(self.centralwidget)
        self.blur_button.setObjectName(u"blur_button")
        self.blur_button.setGeometry(QRect(310, 440, 100, 80))
        self.label_5 = QLabel(self.centralwidget)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(310, 360, 100, 31))
        self.label_5.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.label_6 = QLabel(self.centralwidget)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(410, 360, 100, 31))
        ...
        self.noise_Box.setGeometry(QRect(410, 385, 100, 55))
        self.noise_button = QPushButton(self.centralwidget)
        self.noise_button.setObjectName(u"noise_button")
        self.noise_button.setGeometry(QRect(410, 440, 100, 80))
        self.label_7 = QLabel(self.centralwidget)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(510, 360, 100, 31))
        self.label_7.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.fft_Box = QComboBox(self.centralwidget)
        self.fft_Box.addItem("")
        self.fft_Box.addItem("")
        self.fft_Box.addItem("")
        self.fft_Box.setObjectName(u"fft_Box")
        self.fft_Box.setGeometry(QRect(510, 385, 100, 55))
        self.fft_button = QPushButton(self.centralwidget)
        self.fft_button.setObjectName(u"fft_button")
        self.fft_button.setGeometry(QRect(510, 440, 100, 80))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"\u51e0\u4f55\u53d8\u6362\u65b9\u5f0f", None))
        ...
        self.blur_button.setText(QCoreApplication.translate("MainWindow", u"\u56fe\u50cf\u6a21\u7cca", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"\u56fe\u50cf\u6a21\u7cca\u65b9\u6cd5", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"\u6a21\u62df\u751f\u6210\u566a\u58f0", None))
        self.noise_Box.setItemText(0, QCoreApplication.translate("MainWindow", u"\u9ad8\u65af\u566a\u58f0", None))
        self.noise_Box.setItemText(1, QCoreApplication.translate("MainWindow", u"\u6591\u70b9\u566a\u58f0", None))
        self.noise_Box.setItemText(2, QCoreApplication.translate("MainWindow", u"\u6912\u76d0\u566a\u58f0", None))

        self.noise_button.setText(QCoreApplication.translate("MainWindow", u"\u6dfb\u52a0\u566a\u58f0", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"\u5085\u91cc\u53f6\u53d8\u6362", None))
        self.fft_Box.setItemText(0, QCoreApplication.translate("MainWindow", u"\u9891\u8c31\u56fe", None))
        self.fft_Box.setItemText(1, QCoreApplication.translate("MainWindow", u"\u9ad8\u901a\u6ee4\u6ce2\u5668", None))
        self.fft_Box.setItemText(2, QCoreApplication.translate("MainWindow", u"\u4f4e\u901a\u6ee4\u6ce2\u5668", None))

        self.fft_button.setText(QCoreApplication.translate("MainWindow", u"\u5085\u91cc\u53f6\u53d8\u6362", None))
